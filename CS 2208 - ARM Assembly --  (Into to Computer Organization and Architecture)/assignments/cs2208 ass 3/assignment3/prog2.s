...
;ignores case and special characters
	...
	;r2 is another character to point to the current character in the string from the other end
	...
	LDR r5,=EoS 			;make r5 to point to EoS (end of string, so we can check if we reach the end)
